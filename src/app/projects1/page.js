                    ...
                    <div className="card relative " id={id} ref={ref}>
                        ...
                        <div className="card-wrapper  ">
                            <div className="flip-card-inner">
                                ...
                                <div className="flip-card-back flex flex-col justify-center items-center space-y-12 bg-gray-900 border border-white-700 rounded-lg p-4">
                                    <div><h2 className='text-[23px] font-[anzo1]'>{headingtext}</h2></div>
                                    <div> <p className='text-[.8vw] font-[anzo2] w-[19vw] break-all leading-8'>{backText}</p></div>
